...
2) Upload the precompiled VISION file (or compile this repository's code yourself, and then upload the executable) via the web dashboard. Use hostname wpilibpi.local to connect to the interface.
